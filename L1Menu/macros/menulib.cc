...
bool
DoubleTAU_10200506765448768673
(L1Analysis::L1AnalysisL1UpgradeDataFormat* data)
{
  size_t nobj = 0;
  std::vector<int> candidates;
...
bool
DoubleTAU_10200506829873278128
(L1Analysis::L1AnalysisL1UpgradeDataFormat* data)
{
  size_t nobj = 0;
  std::vector<int> candidates;
...
bool
InvariantMass_16723430859419575066
(L1Analysis::L1AnalysisL1UpgradeDataFormat* data)
{
    size_t nobj0 = 0;
  std::vector<int> candidates;
...
bool
InvariantMass_16723430859419591450
(L1Analysis::L1AnalysisL1UpgradeDataFormat* data)
{
    size_t nobj0 = 0;
  std::vector<int> candidates;
...
bool
L1_AlwaysTrue_copy(L1Analysis::L1AnalysisL1UpgradeDataFormat* data, L1Analysis::L1AnalysisL1CaloTowerDataFormat* calo_tower)
{
  return SingleEXT_1189548080491112364(data) or ( not SingleEXT_1189548080491112364(data));
}
bool
...
{
  return DoubleTAU_10200506765448768673(data);
}
bool
...
{
  return DoubleTAU_10200506829873278128(data);
}
bool
...
{
  return InvariantMass_16723430859419575066(data);
}
bool
...
{
  return InvariantMass_16723430859419591450(data);
}
bool
...
{
  return SingleMU_9379434261777827232(data) and SingleTAU_7742817812181621550(data);
}
bool
...
{
  return SingleMU_9379434261777827232(data) and SingleTAU_9904545633319459630(data);
}
bool
